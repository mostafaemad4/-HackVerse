...
window.addEventListener('DOMContentLoaded', function() {
    ...
    if (setdark === "true") {
        ...
        document.getElementsByClassName('alt').style.background = "black";
    } else {
...
document.querySelector(".fa-moon").addEventListener("click", function () {
    ...
    if (dark) {
        ...
        document.getElementById('banner').style.background = "black";
        document.getElementById('search').style.background = "black";
        document.querySelector('.alt').style.background = "black";
